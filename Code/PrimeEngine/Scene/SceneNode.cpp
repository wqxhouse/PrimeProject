...
// Constructor -------------------------------------------------------------
SceneNode::SceneNode(PE::GameContext &context, PE::MemoryArena arena, Handle hMyself) : Component(context, arena, hMyself), m_lights(context, arena, 1000), m_inheritPositionOnly(false), m_testmodels(context, arena, 10)
{
}
