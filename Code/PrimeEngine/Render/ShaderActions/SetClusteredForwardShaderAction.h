#ifndef __PYENGINE_2_0_SetClusteredForwardShaderAction_SHADER_ACTION_H__
#define __PYENGINE_2_0_SetClusteredForwardShaderAction_SHADER_ACTION_H__
...
struct SetClusteredForwardShaderAction : ShaderAction
{
	SetClusteredForwardShaderAction(PE::GameContext &context, PE::MemoryArena arena)
	{
		m_arena = arena; m_pContext = &context;
	}

	virtual ~SetClusteredForwardShaderAction() {}
