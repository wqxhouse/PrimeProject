...
#include "SetClusteredShadingConstantShaderAction.h"

namespace PE {
	using namespace Components;

	void SetClusteredShadingConstantsShaderAction::bindToPipeline(Effect *pCurEffect /* = NULL*/)
	{
		...
		// TODO: make sure buffer_id does not conflict
	...
	void SetClusteredShadingConstantsShaderAction::unbindFromPipeline(Components::Effect *pCurEffect/* = NULL*/)
	{}

	void SetClusteredShadingConstantsShaderAction::releaseData()
	{}


#if APIABSTRACTION_OGL
	void SetClusteredShadingConstantsShaderAction::PerEffectBindIds::initialize(Effect *pEffect)
	{
#if APIABSTRACTION_IOS 
	...
	void SetClusteredShadingConstantsShaderAction::PerEffectBindIds::initializeLightCGParams(unsigned int index, LightCGParams &out_v, LightCGParams &out_f, Effect *pEffect)
	{
#if APIABSTRACTION_IOS
		char index_num[8];
