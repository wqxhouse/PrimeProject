...
namespace ATG
{
	...
	public:
		...
		INT MapAvatarJointToNUI_POSITION_INDEX(DWORD avatarJointIndex);
		INT MapAvatarJointToIntIndex(DWORD avatarJointIndex);
		XMVECTOR GetAvatarJointWorldPosition(DWORD avatarJointIndex);
		XMVECTOR GetNUI_POSITION_INDEXWorldPosition(NUI_SKELETON_POSITION_INDEX index);
